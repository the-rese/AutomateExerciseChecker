...
FOLDER_PATH = r'C:\\Users\\Therese Bolabola\\OneDrive\\Desktop\\ExerciseTracker\\test\\pushups'
...
def exerciseRater(dir, gender_list, name_list, counter_list, correct_rep_list, st_list, rom_list, ave_depth_list):
    ...
    for fileName in fileNames:
        ...
        instance = PushupClass(filepath, gender)
...
def main():
    ...
    print(df)
    out_filename = 'pushups-right-demo-summary.xlsx'
